    ...
    : IDisposable
{
    ...
    {
        await _fileDownloadManager.InitiateDownloadList(tempHandler, missingFiles, UmbraSync.MareConfiguration.Models.TextureCompressionMode.AlwaysSourceQuality, new HashSet<string>(StringComparer.Ordinal), token).ConfigureAwait(false);
