    ...
    private static IReadOnlyList<ChangelogEntry> BuildEntries()
    {
        return new List<ChangelogEntry>
        {
            new(new Version(3, 0, 0, 6), "3.0.0.6", new List<ChangelogLine>
            {
                ...
                new("Nouveauté : La capacité maximale d'une syncshell est affichée sur sa carte, et peut aller jusqu'à 300 membres."),
                new("Amélioration : Redraw intelligent. Un simple changement de texture ou de matériau réapplique l'apparence sans redraw complet — moins de clignotement et moins de charge. Les changements de modèle, cheveux, visage ou queue déclenchent toujours un redraw complet. Activé par défaut, désactivable dans Réglages → Transferts."),
                ...
                new("Amélioration : Les PNJ tiennent désormais leur position exacte, sans dérive."),
                ...
                new("Correction : La capacité réelle d'une syncshell est affichée correctement — toutes affichaient auparavant la même valeur."),
                new("Amélioration : Le message d'arrivée dans une SyncSlot ne dit plus « Bienvenue chez Le Lys d'Or » mais « Le Lys d'Or vous accueille »."),
